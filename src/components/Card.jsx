...
function Card({ name, image, price, coursetype }) {
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="card-title-area">
                  <span>{name}</span>
                  <span className="card-tag">{coursetype}</span>
        </div>
        <div className="card-body">
          ...
          <div className="feature-grid">
            ...
            <div className="feature-item">
              ...
              <span className="feature-text">Problem Solving</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">Doubt Resolution</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">Various Problem-Solution</span>
            </div>
          </div>
